...
| SELF-06 | Slow trait/preference change, habits, skills, evidence/drift limits | Partial: source-linked bounded skills, contextual activity/place/time rhythms with lapse and reactivation, evidence-backed competition between rhythms in the same part of day, capped week-spanning preference lifecycle, and one-point month-spanning behavioral trait drift | P6 |
