...
| SELF-05 | Decisions balance values, needs, emotion, commitments and feasible options | Partial: sourced values + primary/mixed emotional planning bias + open-vocabulary activity proposals checked against energy/rest/mastery/windows; critical needs can redirect one optional hour per day | P3 |
| SELF-06 | Slow trait/preference change, habits, skills, evidence/drift limits | Partial: source-linked bounded skills, contextual activity/place/time rhythms with lapse and reactivation, capped week-spanning preference lifecycle, and one-point month-spanning behavioral trait drift | P6 |
