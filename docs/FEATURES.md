...
| SOCIAL-02 | Multi-turn greeting, small talk, questions, storytelling, topic shifts, exits | Partial: bounded typed scene/turn/topic/exit lifecycle + one integrated exchange | P3 |
