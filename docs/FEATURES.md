...
| WORLD-03 | Objects, ownership, condition, inventory, borrowing/gifts/repairs | Partial: repair/transfers, finite community resources, quantified delivered supplies, use-driven wear, maintenance, and fallible replenishment | P3 |
