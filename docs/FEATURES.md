...
| WORLD-05 | NPC-private state, needs, calendars, beliefs and plans | Partial: persisted state + three owned evidence-linked scheduled plan profiles | P3 |
| WORLD-06 | Event causes, lead time, stakes, cooldowns, participation | Partial: typed weather + rotating weekly events with lead time/cooldowns | P5 |
...
| WORLD-08 | Seasons, recurring events, evolving projects, world packs | Partial: replayable seasons + four-event weekly neighborhood rhythm | P6 |
...
| SOCIAL-02 | Multi-turn greeting, small talk, questions, storytelling, topic shifts, exits | Partial: typed lifecycle + one bounded performer-driven exchange with audited fallback | P3 |
