...
| SELF-02 | Multidimensional affect, named emotion, duration, appraisal, episodes and baseline mood | Partial: replayable primary/secondary mixed emotion, prolonged-low tracking, source-linked valence/arousal episodes and recovery, plus bounded effects on conversational openness, warmth, hesitation, length, and cadence | P2 |
...
| INNER-06 | Partial dream recall, waking affect, inspiration, fading | Partial: recall/capped affect plus an expiring non-authoritative possibility; an aligned ordinary activity may cite that possibility only after normal feasibility acceptance, and its later success or failure closes the link without turning dream fiction into evidence or action authority; a two-week influence cooldown prevents recurring dream motifs from taking over ordinary agency | P4 |
