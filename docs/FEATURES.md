...
| MEM-08 | Intentional imperfect recall distinct from world truth | Partial: accessibility-driven omission plus source-linked, confidence-losing subjective reconsolidation after actual hazy recall; emotional bias, blending, and correction remain | P2 |
