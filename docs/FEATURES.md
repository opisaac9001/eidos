...
| SELF-08 | Physical comfort, minor illness, recovery and capacity effects | Partial: rare replayable non-clinical one-to-three-day episodes with monotonic recovery and bounded effects on attention, mood, plans and availability; a morning too bad to work through means ringing in sick for that shift, and he says he is unwell when asked | P3–P6 |
...
| ID | Feature | Status | Phase |
| --- | --- | --- | --- |
| WORLD-01 | Places, routes, travel, opening hours, occupancy, perception | Partial: four seed places plus replayable registered places with layout/hours/connected-route planning; the 23-place Alderwick pack; source-aware place knowledge (home ground, visits, noticing a place next to where he is, invitations) so his own plans and his map only reach known places, with never-visited places a gentle pull | P3 |
...
| WORLD-08 | Seasons, recurring events, evolving projects, world packs | Partial: replayable seasons/daily texture, open-ended Moira events that become bounded evolving world threads, rare schema-checked entities entering goals, atomic additive entity/character-pack releases, and a derived weekly calendar of public happenings (some called off, found out on arrival) that reaches his choices only at known venues | P6 |
