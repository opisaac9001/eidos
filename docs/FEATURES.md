...
| MEM-08 | Intentional imperfect recall distinct from world truth | Partial: accessibility-driven omission, bounded mood-congruent retrieval, and source-linked confidence-losing subjective reconsolidation colored by feeling at actual hazy recall; blending and correction remain | P2 |
