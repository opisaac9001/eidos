...
| SOCIAL-08 | Follow-ups, anniversaries, remembered preferences, opt-in in-app outreach | Partial: source-linked reminders plus user-controlled memory-grounded in-app outreach with quiet hours, rate limits, pending-reply suppression, and anti-pressure rejection; anniversaries remain | P5 |
