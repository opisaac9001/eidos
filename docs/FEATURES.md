...
| PLAN-05 | Interrupt, postpone, renegotiate, cancel, bounded replan | Partial: interruption, reflection-triggered conflict/travel/open-hours-safe personal rescheduling, feasible two-party promise retiming with delayed independent creditor response + atomic project cancellation | P3 |
