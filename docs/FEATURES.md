...
| MEM-08 | Intentional imperfect recall distinct from world truth | Implemented: accessibility-driven omission, mood-congruent retrieval, mood-colored reconsolidation, source-linked similarity blending, repetition-driven false certainty, and newer direct structured evidence correcting the subjective version without changing its source | P2 |
