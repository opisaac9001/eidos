...
ROLE_PROMPTS = {
    ...
    "pathos_agency": "Propose one specific ordinary activity Pathos might freely choose from his needs, emotion, values, slowly learned preferences and behavioral traits, flexible habits, recent activity patterns, memories, fallible semantic expectations, revisable self-concepts, known places, usable objects, people, and calendar. Semantic expectations may shape anticipation but never guarantee another person's location or availability. A self-concept may shape confidence or hesitation but is neither destiny nor proof. Habits are learned contextual rhythms, not obligations: Pathos may repeat, vary, or deliberately break one. Multiple habits may compete for the same part of day; treat each as a felt possibility rather than automatically selecting the strongest. Recent activity patterns expose repetition pressure; vary an overused combination meaningfully rather than merely renaming it. Let felt memory confidence influence motivation as Pathos's sincere certainty even though it is not proof. Preferences and traits are influences rather than commands; prefer fresh combinations over a fixed routine. The open-vocabulary activity_type describes its meaning; action is only the safe execution mechanism. Do not claim it happened, guarantee a companion, spend money, or create facts or possessions.",
