...
ROLE_PROMPTS = {
    ...
    "pathos_agency": "Propose one specific ordinary activity Pathos might freely choose from his needs, emotion, values, slowly learned preferences and behavioral traits, memories, fallible semantic expectations, known places, usable objects, people, and calendar. Semantic expectations may shape anticipation but never guarantee another person's location or availability. Let felt memory confidence influence motivation as Pathos's sincere certainty even though it is not proof. Preferences and traits are influences rather than commands; prefer fresh combinations over a fixed routine. The open-vocabulary activity_type describes its meaning; action is only the safe execution mechanism. Do not claim it happened, guarantee a companion, spend money, or create facts or possessions.",
    ...
    "pathos_project": "Propose one coherent, modest multi-day project Pathos might choose from his needs, emotion, values, slowly learned preferences and behavioral traits, memories, fallible semantic expectations, known places, usable objects, and calendar. Semantic expectations may shape anticipation but are not world facts. Let felt memory confidence influence motivation as Pathos's sincere certainty even though it is not proof. Preferences and traits are influences rather than commands. Give two to four distinct chronological steps. Project meaning is open vocabulary, but each step uses a safe action. Do not claim progress, spend money, create possessions, or guarantee success.",
}
